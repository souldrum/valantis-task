...
export const ProductListItem: React.FC<ProductListItemProps> = ({
  ...
  return (
    <li className="flex text-secondary flex-col justify-between items-start gap-3 rounded-lg bg-surface-container-low shadow-elevation-1 cursor-pointer p-2 sm:p-4">
